                    ...
                    <Button onClick={() => {
                      ...
                      <Primary>
                        <span
                          ...
                          data-position={'top'}
                          data-tooltip={this.state.discord}
                        >
                          ...
                          <svg
                            ...
                            style={{
                              ...
                              WebkitTransform: `scale(${this.state.copied ? 0.8 : 1})`,
                              msTransform: `scale(${this.state.copied ? 0.8 : 1})`,
                              transform: `scale(${this.state.copied ? 0.8 : 1})`,
                            }}
                          >
