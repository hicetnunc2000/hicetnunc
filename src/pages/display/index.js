...
export default class Display extends Component {
  ...
  componentWillMount = async () => {
    ...
    await GetUserMetadata(this.state.wallet).then(data => {
      ...
      if (data.data.reddit)
        this.setState({ reddit: data.data.reddit })
    })
                ...
                <div>
                  {this.state.site &&
                    <a href={this.state.site}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" style={{ fill: 'var(--text-color)', stroke: 'transparent', marginRight: '10px' }}>
