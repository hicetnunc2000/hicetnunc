                ...
                <div>
                  {this.state.site &&
                    <a href={this.state.site}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16" style={{ color: 'black', marginRight: '10px' }}>
                  ...
                  {this.state.email &&
                    <a href={"mailto:" + this.state.email}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16" style={{ color: 'black', marginRight: '10px' }}>
                  ...
                  {this.state.site &&
                    <a href={"https://twitter.com/" + this.state.twitter}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16" style={{ color: 'black', marginRight: '10px' }}>
                  ...
                  {this.state.site &&
                    <a href={"https://github.com/" + this.state.github}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16" style={{ color: 'black', marginRight: '10px' }}>
