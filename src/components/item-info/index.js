...
export const ItemInfo = ({
  ...
  var available = parseInt(_.values(_.omitBy(owners, (value, key) => !key.startsWith("KT")))[0])
  ...
  const message = available > 0 ? 'collect for ' + Number(swaps[0].xtz_per_objkt) / 1000000 + ' tez' : 'not for sale'
    ...
    <>
      <div className={styles.container}>
        <div className={styles.edition}>
          ...
          !feed ? 
          <div>
          <p>Edition: {available}/{editions}</p>
          </div>
          :
          undefined
          }
